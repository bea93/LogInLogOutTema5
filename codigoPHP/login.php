...
if ($entradaOK) {
    try {
        ...
        if ($resultadoSQL->rowCount() == 1) {
            ...
            session_start();
            $_SESSION['usuarioDAW213DBAppLoginLogout'] = $usuario->T01_CodUsuario;
            ...
            $actualizarFechaSQL->bindParam(":codigo", $_SESSION['usuarioDAW213DBAppLoginLogout']);
            ...
            $actualizarConexionesSQL->bindParam(":codigo", $_SESSION['usuarioDAW213DBAppLoginLogout']);

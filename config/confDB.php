...
//IP del servidor y BBDD a la que se conecta
define("HOST",'mysql:host=192.168.20.19;dbname=DAW213DBProyectoTema5');
//Usuario con el que se conecta
define("USER",'usuarioDAW213DBProyectoTema5');
//Contraseña de los usuarios
define("PASS",'paso');


/*ENTORNO DESARROLLO CASA
define("HOST",'mysql:host=192.168.0.200;dbname=DAW213DBProyectoTema5');
define("USER",'usuarioDAW213DBProyectoTema5');
